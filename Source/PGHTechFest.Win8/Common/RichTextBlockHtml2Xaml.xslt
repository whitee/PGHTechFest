...
>
    ...
    <xsl:template match="/div/P | /div/p" priority="9">
      <Paragraph  FontSize="16"><xsl:apply-templates /></Paragraph>
    </xsl:template>
    <xsl:template match="P | p" priority="0">
      <Span><LineBreak /><xsl:apply-templates /><LineBreak /></Span>
    </xsl:template>
    <xsl:template match="/div/H2 | /div/h2" priority="9">
      <Paragraph  FontSize="26"><xsl:apply-templates /></Paragraph>
    </xsl:template>
      <xsl:template match="/div/H3 | /div/h3" priority="9">
      <Paragraph  FontSize="22"><xsl:apply-templates /></Paragraph>
    </xsl:template>
