...
namespace PGHTechFest.API
{
    ...
    {
        #region Presenters
        public static Presenter Get_Hector_Correa()
        {
            return JsonConvert.DeserializeObject<Presenter>(_Hector_Correa);
        }

        public static Presenter Get_Constantine_Aaron_Cois()
        {
        ...
        #region Sessions
        public static Session Get_Session_37()
        {
            return JsonConvert.DeserializeObject<Session>(_Session_37);
        }
        public static Session Get_Session_38()
        {
...
track_id: null
        ...
        private const string _Session_38 = @"{
id: ""38"",
...
track_id: null
        ...
        private const string _Hector_Correa = @"{
id: ""21"",
name: ""Hector Correa"",
email: """",
...
fullname: ""Hector Correa""
        ...
        private const string _Constantine_Aaron_Cois = @"{
id: ""11"",
